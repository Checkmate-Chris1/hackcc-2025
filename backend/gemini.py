...
def get_results(diseases: str) -> list[dict]:
    """
    Returns the resulsts information from a list of three diseases
    """
    client = genai.Client(api_key=API_KEY)

    explain_prompt = _create_explain_disease_prompt(diseases)
