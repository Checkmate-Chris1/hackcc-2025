...
def get_results(user_input: str) -> dict:
    """
    Returns a dictionary containing the possible disease and its remedies from the user's input.
    """
    prompt = _create_results_prompt(user_input)
    ...
    try:
        ...
        # fallback if API returned invalid JSON
        result = {
            "disease": "Unknown",
